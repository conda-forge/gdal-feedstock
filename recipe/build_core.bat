set "GDAL_OPTIONAL_CORE_STATE=ON"
set "GDAL_DEFERRED_PLUGIN_STATE=ON"
if "%target_platform%" == "win-arm64" (
  set "GDAL_OPTIONAL_CORE_STATE=OFF"
  set "GDAL_DEFERRED_PLUGIN_STATE=OFF"
)
...
cmake -G "Ninja" ^
      ...
      -DGDAL_USE_BLOSC:BOOL=%GDAL_OPTIONAL_CORE_STATE% ^
      -DGDAL_USE_LIBKML:BOOL=%GDAL_OPTIONAL_CORE_STATE% ^
      -DGDAL_USE_SPATIALITE:BOOL=%GDAL_OPTIONAL_CORE_STATE% ^
      -DGDAL_USE_MUPARSER:BOOL=%GDAL_OPTIONAL_CORE_STATE% ^
      -DGDAL_USE_XERCESC:BOOL=%GDAL_OPTIONAL_CORE_STATE% ^
      ...
      -DOGR_REGISTER_DRIVER_ARROW_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DOGR_REGISTER_DRIVER_PARQUET_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_JP2OPENJPEG_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_PDF_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_POSTGISRASTER_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DOGR_REGISTER_DRIVER_PG_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_FITS_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DOGR_REGISTER_DRIVER_XLS_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_GRIB_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_KEA_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_TILEDB_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_NETCDF_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_HDF4_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_HDF5_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_AVIF_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
      -DGDAL_REGISTER_DRIVER_HEIF_FOR_LATER_PLUGIN=%GDAL_DEFERRED_PLUGIN_STATE% ^
